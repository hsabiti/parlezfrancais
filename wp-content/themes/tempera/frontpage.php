...
if($tempera_fronttext1) {?><div id="front-text1"> <h1><?php echo esc_attr($tempera_fronttext1) ?> </h1></div><?php }
...
if($tempera_fronttext2) {?><div id="front-text2"> <h1><?php echo esc_attr($tempera_fronttext2) ?> </h1></div><?php }
